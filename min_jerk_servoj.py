...
start_pose = [-0.08145979255640012, -0.25211363149237404, 0.6601988222800939, 0.18962477643860007, -0.6744994987043054, 1.6089935698367455]
desired_pose = [-0.09751280605111386, -0.2844873325142271, 0.6340945307082531, 0.2724038583986211, 1.8296166889401462, -1.9042139852431486]

orientation_const = desired_pose[3:]
...
while True:
    ...
    if (time.time() - start_time) >= 3:
        ...
        print(state.output_double_register_6)
    con.send(watchdog)
...
trajectory_time = 300  # time of min_jerk trajectory
